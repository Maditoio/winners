...
export async function POST(req: Request) {
  ...
  try {
    ...
    const payCurrency = (process.env.NOWPAYMENTS_PAY_CURRENCY || 'usdtmatic').toLowerCase()
    const priceCurrency = (process.env.NOWPAYMENTS_PRICE_CURRENCY || payCurrency).toLowerCase()
